...
code = code.replace(/text-\[11px\] font-bold leading-snug truncate whitespace-normal line-clamp-2/g, 'text-[10.5px] font-bold truncate whitespace-nowrap');
code = code.replace(/text-\[9px\] font-black uppercase tracking-wider block mb-0 opacity-70/g, 'text-[9px] font-black uppercase tracking-wider block mb-0 opacity-70 leading-none');
